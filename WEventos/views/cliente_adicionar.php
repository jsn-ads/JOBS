            ...
            <div class="col">
                <div class="table-cliente">
                    <form action="" method="post" id="form-cliente">
                        <div class="top">
                            <a href="" class="btn btn-dark btn-lg btn-add-edit" disabled="true">Adicionar Cliente</a>
                        </div>
                        <div class="session-add-edit">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input id="nome" class="form-control t" type="text" name="nome" placeholder="Cliente Nome">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input id="email" class="form-control t" type="email" name="email" placeholder="Email">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        <input id="instagran" class="form-control t" type="text" name="instagran" placeholder="Instagran">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <textarea id="observacao" class="form-control" name="observacao" rows="3" placeholder="observação..."></textarea>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php endif;?>
                        <div class="botton">
                            <input id="cliente-submit" type="submit" class="btn btn-outline-dark btn1" value="Adicionar">
