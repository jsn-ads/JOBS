                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input id="descricao" class="form-control t" type="text" name="descricao" placeholder="Descrição" value="<?php echo utf8_encode($info['descricao']);?>">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <input id="valor" class="form-control t" type="text" name="valor" placeholder="Valor de Revenda" value="<?php echo utf8_encode($info['preco']);?>">
                                     </div>
                                </div>
                            </div>
                        </div>
