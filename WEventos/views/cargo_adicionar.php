            ...
            <div class="col">
                <div class="table-cargo">
                    <form action="" method="post" id="form-cargo">
                        <div class="c1">
                            <a href="" class="btn btn-dark btn-lg btn-add-edit" disabled="true">Adicionar Cargo</a>
                        </div>
                        <div class="c2">
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <input id="nome" class="form-control t" type="text" name="nome" placeholder="Cargo">
                                    </div>
                                </div>

                                <div class="col-4">
                                    <div class="form-group">
                                        <input id="valor" class="form-control t" type="text" name="valor" placeholder="Valor R$:">
                                    </div>
                                </div>
                            </div>
                        </div>
